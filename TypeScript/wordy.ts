const validOperations: string[] = ["plus", "minus", "multiply", "divide"];
...
function hasAlternatingTypes(arr: Component[]): boolean {
...
function calculateResult(arr: Component[]): number {
